...
const GLfloat ZOOM       =  45.0f;
 ...
 GLfloat MAP_MIN_X = -11.0f;  
 GLfloat MAP_MAX_X = 12.11f;   
 GLfloat MAP_MIN_Y = -3.06f;   
 GLfloat MAP_MAX_Y = 3.0f;   
 GLfloat MAP_MIN_Z = -10.0f;  
 GLfloat MAP_MAX_Z = 10.0f;   
...
public:
    ...
    void ProcessKeyboard(Camera_Movement direction, GLfloat deltaTime) {
        ...
        if ((this->position.x < strikeX) && (this->position.z < strikeZ)) this->position.z = strikeZ;
